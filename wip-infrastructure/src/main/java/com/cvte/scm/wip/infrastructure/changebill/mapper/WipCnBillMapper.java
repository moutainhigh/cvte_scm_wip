...
public interface WipCnBillMapper extends CommonMapper<WipCnBillDO> {
    ...
    List<WipCnBillDO> selectSyncFailedBills(@Param("errMsgList") List<String> errMsgList, @Param("organizationId") String organizationId, @Param("factoryId") String factoryId);
