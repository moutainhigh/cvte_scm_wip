...
public class WipIncrementalWritingJobHandler extends IJobHandler {
    ...
    public WipIncrementalWritingJobHandler(@Qualifier("pgBatchMapper") BaseBatchMapper batchMapper,
                                           WipReqHeaderRepository headerRepository, WipReqLineRepository linesRepository) {
    ...
    public ReturnT<String> execute(Map<String, Object> map) {
        ...
        batchMapper.insert(addedHeaderData);
