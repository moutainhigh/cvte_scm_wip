...
public interface WipMtrRtcLineRepository extends WipBaseRepository<WipMtrRtcLineEntity> {
     ...
     */
    List<WipReqItemVO> batchSumMoUnPostQty(WipMtrRtcQueryVO queryVO);
     ...
     * @param queryVO headerId非空时, 排除这个headerId对应的领料单
     */
    List<WipReqItemVO> batchSumItemUnPostQty(WipMtrRtcQueryVO queryVO);
     ...
     * @param queryVO headerId非空时, 排除这个headerId对应的领料单
     */
    List<WipReqItemVO> batchSumItemLotUnPostQty(WipMtrRtcQueryVO queryVO);
