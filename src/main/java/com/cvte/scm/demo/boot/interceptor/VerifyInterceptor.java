package com.cvte.scm.demo.boot.interceptor;
...
public class VerifyInterceptor implements HandlerInterceptor {
    ...
    private void initUserUnitContext(String userOrgRelationId) {
        ...
        sysBehaviorService.initUserUnitContext(userOrgRelationId);
    }
    ...
    private void initUserContext(String userToken, String remoteAddress) {
        ...
        sysBehaviorService.initUserContext(claim.getSub(), remoteAddress);
